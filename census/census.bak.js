<link rel="stylesheet" class="aplayer-secondary-style-marker" href="/assets/css/APlayer.min.css"><script src="/assets/js/APlayer.min.js" class="aplayer-secondary-script-marker"></script>var metrics     = 'pv_count' // 统计访问次数 PV 填写 'pv_count'，统计访客数 UV 填写 'visitor_count'，二选一
...
function pvChart () { 
    ...
    title: {
        text: '站点访问量统计',
        subtext: '数据来源: 百度统计（自 2021/08/26 开始统计）',
        textStyle: {
            color: '#504b4d',
        }
    },
